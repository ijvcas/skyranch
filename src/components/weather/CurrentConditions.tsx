    ...
    <div className="weather-frosted-card" style={{ padding: '12px 16px' }}>
      <div className="weather-detail-grid" style={{ gap: '12px' }}>
        <div className="weather-detail-item">
          ...
          <h4 style={{ fontSize: '11px', opacity: 0.7, margin: '4px 0 2px' }}>{t('forecast.wind')}</h4>
        ...
        <div className="weather-detail-item">
          ...
          <h4 style={{ fontSize: '11px', opacity: 0.7, margin: '4px 0 2px' }}>{t('forecast.humidity')}</h4>
          <p style={{ fontSize: '18px', fontWeight: '600' }}>{humidity !== null ? `${humidity}%` : "N/A"}</p>
        </div>
        <div className="weather-detail-item">
          <WiRaindrop style={{ fontSize: '32px', color: 'white' }} />
          <h4 style={{ fontSize: '11px', opacity: 0.7, margin: '4px 0 2px' }}>{t('forecast.rain')}</h4>
        ...
        <div className="weather-detail-item">
          ...
          <h4 style={{ fontSize: '11px', opacity: 0.7, margin: '4px 0 2px' }}>{t('forecast.min')}/{t('forecast.max')}</h4>
